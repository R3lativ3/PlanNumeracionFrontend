...
export class ServidoresService {
  ...
  public getAdvancedSearchServidorXLS(servidor: servidor2){
   /* let httpHeaders = new HttpHeaders({'Content-Type' : 'application/json', 'Accept': 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'});
    const body=JSON.stringify(servidor)
    return this.http.post<Blob>(`${this.url}/api/servidores/servidor/advanced-search/xls`, body, {headers: httpHeaders, responseType?: 'arraybuffer' }) 
    */
