...
export class AllComponent implements OnInit {
  ...
  this.backend.getAdvancedSearchServidorXLS(this.advancedSearchServidores).subscribe(file => {
    ...
    const blob:Blob = new Blob([file], { type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' });
    console.log(blob)
    ...
    downloadLink.setAttribute('download', "prescription.xls");
