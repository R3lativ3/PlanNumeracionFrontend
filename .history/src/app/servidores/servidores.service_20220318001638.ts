...
export class ServidoresService {
  ...
  public searchServidor(hostname: string, page: number, option: number){
    return this.http.get<PaginatedServidor>(`${this.url}/api/servidores/servidor/property?page=${page}&hostnameList=${hostname}`) 
  }
