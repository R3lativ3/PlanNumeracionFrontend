...
export class EditComponent implements OnInit {
  ...
  modifiedValues(base: aplicacion, model: aplicacion, ref: {hasChange: boolean, _text: string}): void{
  ...
  update(){
    let text = ''
    let hasChange = false
    this.modifiedValues(this.base, this.model, {hasChange: hasChange, _text: text})
    if(hasChange){
      Swal.fire({
