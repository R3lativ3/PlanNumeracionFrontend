...
export class ActividadesService {
  ...
  public allEjecucionActividades(){  
    return this.http.get<ejecucionActividad[]>(`${this.url}/api/catalogos/ubicaciones-fisicas`)
  }

  public getEjcucionActividad(id: number){  
    return this.http.get<ejecucionActividad>(`${this.url}/api/catalogos/ubicaciones-fisicas/${id}`)
  }
  ...
  public updateEjecucionActividad(body: ejecucionActividadPost, id: number){  
    return this.http.put<Response>(`${this.url}/api/catalogos/ubicaciones-fisicas/${id}`, body)
  }
