...
import { actividad, actividadPost, busquedaEjecuciones, ejecucionActividad, ejecucionActividadPost, responsablesActividad, tiposActividad } from './actividades.model';
...
export class ActividadesService {
  ...
  public allEjecucionActividades(page: number){  
    ...
    return this.http.get<ejecucionActividad[]>(`${this.url}/api/actividades/ejecuciones-actividad/all/${page}`)
  }
  ...
  public advancedSearchDownloadFile(){  
    let l: busquedaEjecuciones = {
      idActividad : 4,
      idEstatus: 1
    }
    return this.http.post(`${this.url}/api/actividades/ejecuciones-actividad/advanced-search/evidence`, l, {
