...
export class ActividadesService {
  ...
  public advancedSearchDownloadFile(search: busquedaEjecuciones){  
    return this.http.post(`${this.url}/api/actividades/ejecuciones-actividad/advanced-search/evidence`, search, {
