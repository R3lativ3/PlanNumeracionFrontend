...
export class SearchComponent implements OnInit {
  ...
  constructor(private backend: ActividadesService, private backendEstatus: EstatusEjecucionService, private PeriodicidadesService: PeriodicidadService) { }
